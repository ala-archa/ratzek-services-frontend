    ...
    resources: {
      en: {
        translation: {
          ...
          wf_vis_legend: "< 1 km — risk of losing visibility (whiteout).",
          wf_row_uv: "UV index",
      ...
      ru: {
        translation: {
          ...
          wf_vis_legend: "< 1 км — риск потери видимости (whiteout).",
          wf_row_uv: "UV-индекс",
      ...
      kg: {
        translation: {
          ...
          wf_vis_legend: "< 1 км — көрүнүүнү жоготуу коркунучу (whiteout).",
          wf_row_uv: "UV-индекс",
